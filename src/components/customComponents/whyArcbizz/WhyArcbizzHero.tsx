...
import { Star, Sparkles, Target, Award, ArrowRight, Phone } from 'lucide-react'
import { Button } from '@/components/ui/button'
import { useRouter } from 'next/navigation'

const WhyArcbizzHero = () => {
    const router = useRouter();
    return (
        <section id="why-arcbizz-hero" className="relative flex items-center justify-center min-h-[80vh] pt-24 pb-16 px-4 overflow-hidden bg-background animate-fade-in-up">
            ...
            <div className="relative z-10 flex flex-col items-center justify-center gap-6 max-w-5xl mx-auto text-center">
                ...
                <div className="relative animate-fade-in-down">
                    ...
                    <div className="relative border border-primary/30 text-primary bg-card/70 rounded-full px-6 py-2.5 flex items-center justify-center gap-2">
                        ...
                        <span className="font-semibold uppercase text-xs lg:text-sm">Why Choose Us</span>
                    </div>
                </div>
                ...
                <div className="flex flex-col gap-4 animate-fade-in" style={{ animationDelay: '0.1s' }}>
                    ...
                    <p className="text-base sm:text-lg lg:text-xl xl:text-2xl text-muted-foreground font-normal mt-2 max-w-3xl mx-auto leading-relaxed">
                        We're not just another software development company. We're your strategic technology partner, committed to delivering exceptional results that drive your business forward.
                    </p>
                </div>
