...
import { Briefcase, Sparkles, Users, Rocket, ArrowRight, Phone } from 'lucide-react'
...
const CareerHero = () => {
    ...
    return (
        <section id="career-hero" className="relative flex items-center justify-center min-h-[80vh] pt-24 pb-16 px-4 overflow-hidden bg-background animate-fade-in-up">
            ...
            <div className="relative z-10 flex flex-col items-center justify-center gap-6 max-w-5xl mx-auto text-center">
                ...
                <div className="flex flex-col gap-4 animate-fade-in" style={{ animationDelay: '0.1s' }}>
                    ...
                    <p className="text-base sm:text-lg lg:text-xl xl:text-2xl text-muted-foreground font-normal mt-2 max-w-3xl mx-auto leading-relaxed">
                        We're a young, dynamic team building the future of digital innovation. Founded in 2023, we're on an exciting journey of growth and looking for passionate individuals who want to make an impact from day one.
                    </p>
                    <p className="text-base sm:text-lg lg:text-xl xl:text-2xl text-muted-foreground font-normal max-w-2xl mx-auto leading-relaxed">
                        Join us and be part of a company where your ideas matter, your growth is prioritized, and your work shapes the future.
                    </p>
                </div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-8 mt-10 w-full max-w-4xl animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
                    <div className="bg-card/50 backdrop-blur-sm border border-border rounded-2xl p-4 md:p-6 hover:border-primary/30 transition-all duration-300">
                        ...
                        <div className="text-2xl md:text-3xl font-bold text-foreground mb-1">1+</div>
                        <div className="text-xs md:text-sm text-muted-foreground">Year of Growth</div>
                    </div>
                    <div className="bg-card/50 backdrop-blur-sm border border-border rounded-2xl p-4 md:p-6 hover:border-primary/30 transition-all duration-300">
                        <div className="flex items-center justify-center w-12 h-12 rounded-full bg-primary/10 mb-3 mx-auto">
                            <Users className="w-6 h-6 text-primary" />
                        </div>
                        <div className="text-2xl md:text-3xl font-bold text-foreground mb-1">Growing</div>
                    ...
                    <div className="bg-card/50 backdrop-blur-sm border border-border rounded-2xl p-4 md:p-6 hover:border-primary/30 transition-all duration-300">
                        ...
                        <div className="text-2xl md:text-3xl font-bold text-foreground mb-1">Open</div>
                    ...
                    <div className="bg-card/50 backdrop-blur-sm border border-border rounded-2xl p-4 md:p-6 hover:border-primary/30 transition-all duration-300">
                        ...
                        <div className="text-2xl md:text-3xl font-bold text-foreground mb-1">Fast</div>
                        <div className="text-xs md:text-sm text-muted-foreground">Career Growth</div>
                    </div>
                </div>
