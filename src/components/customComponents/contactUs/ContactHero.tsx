...
const ContactHero = () => {
    ...
    return (
        <section id="contact-hero" className="relative flex items-center justify-center min-h-[70vh] pt-24 pb-16 px-4 overflow-hidden bg-background animate-fade-in-up">
            ...
            <div className="relative z-10 flex flex-col items-center justify-center gap-6 max-w-5xl mx-auto text-center">
                ...
                <div className="relative animate-fade-in-down">
                    ...
                    <div className="relative border border-primary/30 text-primary bg-card/70 rounded-full px-6 py-2.5 flex items-center justify-center gap-2" onClick={() => {
                        router.push('/contact-us#contact-form');
                    }}>
                        <MessageCircle className="w-5 h-5 text-primary" />
                        <span className="font-semibold uppercase text-xs lg:text-sm">Get in Touch</span>
                    </div>
                </div>
                ...
                <div className="flex flex-col gap-4 animate-fade-in" style={{ animationDelay: '0.1s' }}>
                    ...
                    <p className="text-base sm:text-lg lg:text-xl xl:text-2xl text-muted-foreground font-normal mt-2 max-w-3xl mx-auto leading-relaxed">
                        Have a project in mind? We're here to help turn your ideas into reality. Reach out and let's discuss how we can bring your vision to life.
                    </p>
                </div>

                {/* Quick Contact Cards */}
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 md:gap-6 mt-8 w-full max-w-4xl animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
                    <div className="bg-card/50 backdrop-blur-sm border border-border rounded-2xl p-4 md:p-6 hover:border-primary/30 transition-all duration-300">
                        ...
                        <div className="text-sm font-semibold text-foreground mb-1">Email Us</div>
                        <div className="text-xs md:text-sm text-muted-foreground">info@arcbizz.com</div>
                    </div>
                    <div className="bg-card/50 backdrop-blur-sm border border-border rounded-2xl p-4 md:p-6 hover:border-primary/30 transition-all duration-300">
                        <div className="flex items-center justify-center w-12 h-12 rounded-full bg-primary/10 mb-3 mx-auto">
                            <Phone className="w-6 h-6 text-primary" />
                        </div>
                        <div className="text-sm font-semibold text-foreground mb-1">Call Us</div>
                        <div className="text-xs md:text-sm text-muted-foreground">+91 87580 27188</div>
                    </div>
                    <div className="bg-card/50 backdrop-blur-sm border border-border rounded-2xl p-4 md:p-6 hover:border-primary/30 transition-all duration-300">
                        <div className="flex items-center justify-center w-12 h-12 rounded-full bg-primary/10 mb-3 mx-auto">
                        ...
                        <div className="text-xs md:text-sm text-muted-foreground">Within 24 hours</div>
                    </div>
                </div>
            </div>
