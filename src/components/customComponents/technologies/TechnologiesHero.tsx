...
import { Code2, Sparkles, Cpu, Zap, ArrowRight, Phone } from 'lucide-react'
import { Button } from '@/components/ui/button'

const TechnologiesHero = () => {
    return (
        <section id="technologies-hero" className="relative flex items-center justify-center min-h-[80vh] pt-24 pb-16 px-4 overflow-hidden bg-background animate-fade-in-up">
            ...
            <div className="relative z-10 flex flex-col items-center justify-center gap-6 max-w-5xl mx-auto text-center">
                ...
                <div className="relative animate-fade-in-down">
                    ...
                    <div className="relative border border-primary/30 text-primary bg-card/70 rounded-full px-6 py-2.5 flex items-center justify-center gap-2">
                        ...
                        <span className="font-semibold uppercase text-sm">Our Technology Stack</span>
                    </div>
                </div>
                ...
                <div className="flex flex-col gap-4 animate-fade-in" style={{ animationDelay: '0.1s' }}>
                    ...
                    <p className="text-lg sm:text-xl lg:text-2xl text-muted-foreground font-normal mt-2 max-w-3xl mx-auto leading-relaxed">
                        We leverage the latest and most powerful technologies to build scalable, secure, and innovative solutions that drive your business forward. Our expertise spans across modern frameworks, cloud platforms, and development tools.
                    </p>
                </div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-8 mt-10 w-full max-w-4xl animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
                    ...
                    <div className="bg-card/50 backdrop-blur-sm border border-border rounded-2xl p-4 md:p-6 hover:border-primary/30 transition-all duration-300">
                        ...
                        <div className="text-2xl md:text-3xl font-bold text-foreground mb-1">Full</div>
                        <div className="text-xs md:text-sm text-muted-foreground">Stack Expertise</div>
                    </div>
                    <div className="bg-card/50 backdrop-blur-sm border border-border rounded-2xl p-4 md:p-6 hover:border-primary/30 transition-all duration-300">
                        <div className="flex items-center justify-center w-12 h-12 rounded-full bg-primary/10 mb-3 mx-auto">
                            <Zap className="w-6 h-6 text-primary" />
                        </div>
                        <div className="text-2xl md:text-3xl font-bold text-foreground mb-1">Cloud</div>
                        <div className="text-xs md:text-sm text-muted-foreground">Native Solutions</div>
                    </div>
                    <div className="bg-card/50 backdrop-blur-sm border border-border rounded-2xl p-4 md:p-6 hover:border-primary/30 transition-all duration-300">
                        <div className="flex items-center justify-center w-12 h-12 rounded-full bg-primary/10 mb-3 mx-auto">
                            <Sparkles className="w-6 h-6 text-primary" />
                        </div>
                        <div className="text-2xl md:text-3xl font-bold text-foreground mb-1">Always</div>
                        <div className="text-xs md:text-sm text-muted-foreground">Up-to-Date</div>
                    </div>
                </div>
                ...
                <div className="flex items-center justify-center gap-4 mt-8 animate-fade-in-up" style={{ animationDelay: '0.3s' }}>
                    <Button
                        ...
                        onClick={() => {
                            const stackSection = document.getElementById('technology-stack');
