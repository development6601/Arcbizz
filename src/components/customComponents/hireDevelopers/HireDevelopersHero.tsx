...
import { Code2, Users, Rocket, Target, ArrowRight, Phone, CheckCircle2 } from 'lucide-react'
...
const HireDevelopersHero = () => {
    ...
    return (
        <section id="hire-developers-hero" className="relative flex items-center justify-center min-h-[80vh] pt-24 pb-16 px-4 overflow-hidden bg-background animate-fade-in-up">
            ...
            <div className="relative z-10 flex flex-col items-center justify-center gap-6 max-w-5xl mx-auto text-center">
                ...
                <div className="relative animate-fade-in-down">
                    ...
                    <div className="relative border border-primary/30 text-primary bg-card/70 rounded-full px-6 py-2.5 flex items-center justify-center gap-2">
                        ...
                        <span className="font-semibold uppercase text-xs lg:text-sm">Hire Expert Developers</span>
                    </div>
                </div>
                ...
                <div className="flex flex-col gap-4 animate-fade-in" style={{ animationDelay: '0.1s' }}>
                    ...
                    <p className="text-base sm:text-lg lg:text-xl xl:text-2xl text-muted-foreground font-normal mt-2 max-w-3xl mx-auto leading-relaxed">
                        Hire skilled developers from Arcbizz. We provide expert developers who deliver high-quality solutions, on time and within budget. Scale your team instantly with our proven talent.
                    </p>
                </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mt-8 w-full max-w-3xl animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
                    <div className="bg-card/50 backdrop-blur-sm border border-border rounded-2xl p-6 hover:border-primary/30 transition-all duration-300">
                        ...
                        <div className="text-sm font-semibold text-foreground mb-1">Vetted Talent</div>
                        <div className="text-xs text-muted-foreground">Pre-screened developers</div>
                    </div>
                    <div className="bg-card/50 backdrop-blur-sm border border-border rounded-2xl p-6 hover:border-primary/30 transition-all duration-300">
                        <div className="flex items-center justify-center w-12 h-12 rounded-full bg-primary/10 mb-3 mx-auto">
                            <Rocket className="w-6 h-6 text-primary" />
                        </div>
                        <div className="text-sm font-semibold text-foreground mb-1">Fast Onboarding</div>
                        <div className="text-xs text-muted-foreground">Start in 48 hours</div>
                    </div>
                    <div className="bg-card/50 backdrop-blur-sm border border-border rounded-2xl p-6 hover:border-primary/30 transition-all duration-300">
                        <div className="flex items-center justify-center w-12 h-12 rounded-full bg-primary/10 mb-3 mx-auto">
                            <Target className="w-6 h-6 text-primary" />
                        </div>
                        <div className="text-sm font-semibold text-foreground mb-1">Flexible Models</div>
                        <div className="text-xs text-muted-foreground">Full-time or part-time</div>
                    </div>
                </div>
